...
import { callSheetSchema } from '../schemas/callsheetSchema';
...
const defaultFormValues: CallSheetFormData = {
  ...
  time: '',
  description: '',
  time_table: [{ item: '', date: '' }],
  location: [{ location_title: '', link: '', address: '', contact_number: '' }],
  schedule: [{ time: '', scene: '', description: '' }],
};
                ...
                <Stack gap="md">
                  <Group justify="space-between">
                    <Text size="sm" c="dimmed">
                      Add schedule items for the production day
                    </Text>
                    <Button 
            ...
            <Accordion.Item value="locations">
              ...
              <Accordion.Panel>
                <Stack gap="md">
                  <Group justify="space-between">
                    <Text size="sm" c="dimmed">
                      Add shooting locations with contact details
                    </Text>
                    <Button 
                      leftSection={<IconPlus size={16} />} 
                      variant="light" 
